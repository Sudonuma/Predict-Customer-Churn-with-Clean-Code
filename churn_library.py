'''
this file includes the modules for the project
'predict customer churn' for the second course of
Udacity's machine learning devops program.
...
def encoder_helper(df, category_lst):
    ...
    for i in category_lst:
        lst = []
        groups = df.groupby(i).mean()['Churn']
        for val in df[i]:
